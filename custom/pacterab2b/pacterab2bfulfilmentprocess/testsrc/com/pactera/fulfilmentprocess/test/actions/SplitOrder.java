 ...
 */
package com.pactera.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(Pacterab2bFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Pacterab2bFulfilmentProcessConstants.PARENT_PROCESS);
