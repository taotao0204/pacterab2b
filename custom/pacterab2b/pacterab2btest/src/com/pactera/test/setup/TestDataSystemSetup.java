 ...
 */
package com.pactera.test.setup;
...
import com.pactera.test.constants.Pacterab2bTestConstants;
import com.pactera.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Pacterab2bTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/pacterab2btest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/pacterab2btest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/pacterab2btest/import/cstickets.impex");
			...
			importImpexFile(context, "/pacterab2btest/import/csquotes.impex");
		}
	}
}
