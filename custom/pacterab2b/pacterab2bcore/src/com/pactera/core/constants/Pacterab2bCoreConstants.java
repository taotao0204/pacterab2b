 ...
 */
package com.pactera.core.constants;

/**
 * Global class for all Pacterab2bCore constants. You can add global constants for your extension into this class.
 */
public final class Pacterab2bCoreConstants extends GeneratedPacterab2bCoreConstants
{
	public static final String EXTENSIONNAME = "pacterab2bcore";


	private Pacterab2bCoreConstants()
	{
		//empty
	}
